...
% todo: Add here perimtral-FW.jpg and distributed-FW.jpg images to illustrate the difference between traditional and modern network security architectures.
...
% todo: add image of FAS (Firewall Allocation Schema) to illustrate the concept visually.
