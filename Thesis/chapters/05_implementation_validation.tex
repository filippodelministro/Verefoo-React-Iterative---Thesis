...
\texttt{percentPairs} / \texttt{reachabilityPerc} & \texttt{\{0.5, 0.0\}} & \texttt{0.5} & — \\
\texttt{portSpecifics} / \texttt{usePorts} & \texttt{0.00} & \texttt{false} & \texttt{false} \\
\texttt{isolationBound} & — & — & \texttt{30} \\
